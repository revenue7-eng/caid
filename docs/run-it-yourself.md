...
**Conformance** (`conformance`) means meeting every MUST clause in the [Assessment Standard](standard.html). Checklist in section 10.
...
This is the cheapest check available: anyone can recompute the published numbers in seconds, running nothing and paying nothing. The per-model figures they should match are on the [Report Cards](evidence.html).
...
You can describe testing as following the CAID protocol only when every item is met. Full wording in the [Assessment Standard](standard.html) and in [`PROTOCOL.md`](https://github.com/revenue7-eng/caid-benchmark/blob/main/PROTOCOL.md).
...
| File | What is in it |
|---|---|
| [`PROTOCOL.md`](https://github.com/revenue7-eng/caid-benchmark/blob/main/PROTOCOL.md) | normative specification, MUST clauses, conformance conditions |
| [`REPORT_v1.3.md`](https://github.com/revenue7-eng/caid-benchmark/blob/main/REPORT_v1.3.md) | results under the current violation definition |
| `REPORT_v1.2.md` | results from the previous version, for comparison |
